...
namespace ORB_SLAM3 {
    ...
    public:
        ...
        bool epipolarConstrain(GeometricCamera* pCamera, const cv::KeyPoint& kp1, const cv::KeyPoint& kp2, const Eigen::Matrix3f& R12, const Eigen::Vector3f& t12, const float sigmaLevel, const float unc);
